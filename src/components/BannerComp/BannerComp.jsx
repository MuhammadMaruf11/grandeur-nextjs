...
function BannerComp() {
    return (
        <section className="bg-[url('/img/bg/GrandeuraeMapBG-02.svg')] bg-indigo-950 bg-contain bg-no-repeat bg-center py-20">
            <div className="max-w-5xl py-16 mx-auto px-3">
                <div className="flex flex-col gap-5 lg:gap-10 justify-center items-center mx-auto text-center text-white">
                    ...
                    <p className="md:text-lg text-sm">Whether you&apos;re a small startup or a large enterprise, our team is ready to provide you with a scalable and comprehensive security solution that protects, empowers, and grows with your business.</p>
