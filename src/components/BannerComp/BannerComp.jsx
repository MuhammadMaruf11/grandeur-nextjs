            ...
            <div className="max-w-5xl py-16 mx-auto px-3">
                <div className="flex flex-col gap-5 lg:gap-10 justify-center items-center mx-auto text-center text-white">
                    ...
                    <div className="flex gap-5 justify-start items-center">
                        <Link href='/request-connection' className="border border-indigo-500 text-xl px-4 py-3 backdrop-blur-sm bg-opacity-50 hover:bg-transparent bg-indigo-500 transition-all ease-linear">
                            Request for Connection
                        </Link>
                        <Link href='/consult-expert' className="border border-indigo-500 text-xl px-4 py-3 backdrop-blur-sm hover:bg-opacity-50 hover:bg-indigo-500 bg-transparent transition-all ease-linear">
                            Consult an Expert
                        </Link>
                    </div>
                </div>
